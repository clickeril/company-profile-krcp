    ...
    <>
      ...
      <nav
        className={cn(
          ...
          scrolled || !isHome ? 'bg-white shadow-md py-4 top-0' : 'bg-transparent py-6 top-5'
        )}
      >
          ...
          <div className="flex justify-between items-center">
            ...
            <div className="hidden lg:flex items-center space-x-1">
              {navLinks.map((link) => {
                ...
                return (
                  ...
                  >
                    ...
                    {isActive && (
                      <motion.div className="absolute bottom-0 left-4 right-4 h-[2px] bg-accent" layoutId="nav-underline" />
                    )}
                  </Link>
                );
              })}
              ...
              <div className="pl-4 ml-2 border-l border-white/20">
                 <Link to="/contact" className="bg-accent hover:bg-accent/90 text-primary px-6 py-2.5 rounded-full text-sm font-bold transition-all transform hover:scale-105 active:scale-95 shadow-md">
                   Get a Quote
                 </Link>
              </div>
            </div>
            ...
            <div className="lg:hidden flex items-center">
              <button
                ...
                className={cn("p-2 rounded-md transition-colors", (scrolled || !isHome) ? "text-slate-800" : "text-white")}
              >
            ...
            >
              <div className="px-4 py-6 space-y-2 flex flex-col">
                ...
                <div className="pt-4 mt-2 border-t border-slate-100">
                   <Link to="/contact" onClick={() => setIsOpen(false)} className="w-full flex justify-center bg-primary text-white font-bold py-4 rounded-xl text-lg">
                     Partner With Us
                   </Link>
                </div>
              </div>
